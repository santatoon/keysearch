...
<body>
					...
					<div class="tab-content">
						...
						<div id="login">
							...
							<form:form modelAttribute="login">
								...
								<div class="field-wrap">
									<label class="signlabel"> Email Address<span class="req">*</span>
									</label> <form:input type="email" path="email" required="required" autocomplete="off" />
									<form:errors cssClass="error" path="email" />
								</div>

								<div class="field-wrap">
									<label class="signlabel"> Password<span class="req">*</span>
									</label> <form:input type="password" path="password" required="required" autocomplete="off" />
						...
						<div id="signup">
							...
							<form:form modelAttribute="customer">
								...
								<div class="top-row">
									<div class="field-wrap">
										<label class="signlabel"> First Name<span class="req">*</span>
										</label> <form:input type="text" path="firstname" required="required" autocomplete="off" />
										<form:errors cssClass="error" path="firstname" />
									</div>

									<div class="field-wrap">
										<label class="signlabel"> Last Name<span class="req">*</span>
										</label> <form:input type="text" path="lastname" required="required" autocomplete="off" />
								...
								<div class="field-wrap">
									<label class="signlabel"> Email Address<span class="req">*</span>
									</label> <input type="email" required="required" autocomplete="off" />
									<form:errors cssClass="error" path="email" />
								</div>

								<div class="field-wrap">
									<label class="signlabel"> Set A Password<span class="req">*</span>
									</label> <input type="password" required="required" autocomplete="off" />
									<form:errors cssClass="error" path="password" />
								</div>    
	...
	<script src="../js/sign_index.js"></script>
